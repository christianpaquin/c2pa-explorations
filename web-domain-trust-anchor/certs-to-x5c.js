...
program.option('-p, --public <public>', 'path to the public JWK set to create or add the new key to', 'c2pa.json');
program.option('-s, --private <private>', 'path to the private JWK set to create or add the new key to', 'c2pa.private.json');
